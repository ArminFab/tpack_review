...
**RQ1)** How is teachers’ technological-pedagogical content knowledge (TPCK) conceptualized within research? What different components are defined and on which component does the focus lie (T, P, C, TP, TC, TP, PC, TPC)? 
...
At each of this three steps articles will be included if the inclusion criteria apply and none of the exclusivity criteria apply. If this is not the case, articles will be excluded. If it is not clear whether articles should be included or excluded, these articles will be labelled as “maybe” and then discussed among the raters until consens is reached. Articles will also be discussed together if there are disagreements. These disagreements will be resolved by discussing the article in detaild. If no consens can be reached, another independent reviewer will be brought in for discussion.
...
Note: This list might be subject to change as we start with the revision process.
