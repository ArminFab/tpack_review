...
After selecting the sample used for analysis according to the selection process (see 3.5), each paper of the sample will be read carefully and the infomation (as outlined in 3.7)
